...
export interface TaskExecutionResponse {
  ...
  detail_cap: number;
  detail_cap_skipped: number;
  coverage_status: string;
  search_depth: "quick" | "standard" | "complete" | string;
  extraction_cache_hit_count: number;
  llm_call_count: number;
  llm_timeout_count: number;
  opportunity_count: number;
  lifecycle_count: number;
  source_outcomes: Record<string, Record<string, unknown>>;
